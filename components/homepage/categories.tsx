...
export default function Categories({ isOpen, setIsOpen }: CategoriesProps) {
  ...
  return (
    <>
      ...
      >
       <div className=" p-6 rounded-[40px]  h-[95%] justify-center overflow-scroll relative z-50">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="container justify-center flex flex-col mx-auto h-auto  xl:py-8 ">
            <h1 className=" text-center md:text-left mb-20 responsive-subtitles">
              Shop By Category
            </h1>
            <div className=" lg:grid-cols-2 xl:grid-cols-3  h-auto justify-center  z-30  grid gap-10 p-7 rounded-[41px]">
